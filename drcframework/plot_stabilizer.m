...
for j = 1:3
  ...
  plot(t, com_hat(:, j), 'Color', 'red',     'LineWidth', 2);
...
for j = 1:3
  ...
  title(["zmp", car_comp(j), " des vs mod vs ref"], 'fontsize', 30)
